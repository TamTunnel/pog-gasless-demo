...
import { Search, Image as ImageIcon, CheckCircle, AlertCircle, Loader2 } from "lucide-react";
import { useToast } from "@/components/ui/use-toast";  // Keep as-is, but ensure use-toast.ts exists
